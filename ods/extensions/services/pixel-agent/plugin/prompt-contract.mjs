...
export const ODS_COMPACT_CONVERSATION_CONTRACT = [
  ...
  "Delegate public research to Perplexica via pixel_ods_research with query. Use web_search for discovery and web_fetch/pixel_ods_web_extract for page evidence. Cite actual source URLs in replies and saved files; make the requested recommendation and state uncertainty. Share no private files or chat history without owner authorization.",
